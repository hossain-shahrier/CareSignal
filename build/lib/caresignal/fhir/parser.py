...
def conditions_for_patient(
    ...
    for condition in conditions:
        ...
        if onset is None or onset <= before:
            count += 1
    return count
...
def procedures_for_encounter(
    ...
    for procedure in procedures:
        ...
        if encounter_id and encounter_id not in encounter_ref:
            performed = parse_iso_datetime(procedure.get("performedDateTime"))
